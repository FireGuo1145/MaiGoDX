  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div className="space-y-2">
        <h2 className="text-4xl font-black tracking-tight">Welcome to MaiGoDX Portal</h2>
        ...
        <Card className="bg-slate-900 border-slate-800">
          ...
          <CardContent className="grid grid-cols-2 gap-4 text-center">
            <div className="p-4 bg-indigo-500/10 rounded-xl border border-indigo-500/20">
              ...
              <p className="text-[10px] uppercase tracking-wider text-slate-500">Users</p>
            </div>
            <div className="p-4 bg-emerald-500/10 rounded-xl border border-emerald-500/20">
              <p className="text-2xl font-black text-emerald-400">{stats?.totalPlays || 0}</p>
              <p className="text-[10px] uppercase tracking-wider text-slate-500">Total Plays</p>
            </div>
          </CardContent>
        </Card>
      </div>
