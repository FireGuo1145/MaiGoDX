...
func main() {
	...
	mux.HandleFunc("/api/site/metadata", handler.HandleGetSiteMetadata)
	...
	mux.HandleFunc("/api/admin/metadata", handler.HandleAdminMetadata)
	mux.HandleFunc("/api/admin/metadata/import", handler.HandleAdminMetadataImport)
