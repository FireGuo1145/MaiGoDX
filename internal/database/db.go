...
func InitDB() {
	...
	err = DB.AutoMigrate(
		...
		&model.OngekiUser{},
		&model.OngekiMusicDetail{},
		&model.OngekiPlaylog{},
		&model.OngekiUserRecord{},
		&model.Terminal{},
	...
	defaultConfigs := []model.SystemConfig{
		...
		{Key: "ongeki_maintenance_mode", Value: "false", Desc: "Ongeki 维护模式开关 (true/false)"},
		{Key: "ongeki_request_interval", Value: "10", Desc: "Ongeki 游戏设置请求间隔"},
		{Key: "ongeki_max_count_character", Value: "50", Desc: "Ongeki 游戏设置中的最大角色数量"},
		{Key: "ongeki_max_count_card", Value: "300", Desc: "Ongeki 游戏设置中的最大卡片数量"},
		{Key: "ongeki_max_count_item", Value: "300", Desc: "Ongeki 游戏设置中的最大道具数量"},
		{Key: "ongeki_max_count_music", Value: "50", Desc: "Ongeki 游戏设置中的最大乐曲分组数量"},
		{Key: "ongeki_max_count_music_item", Value: "300", Desc: "Ongeki 游戏设置中的最大乐曲道具数量"},
		{Key: "ongeki_max_count_rival_music", Value: "300", Desc: "Ongeki 游戏设置中的最大对手成绩数量"},
		{Key: "ongeki_endpoint_salts", Value: "", Desc: "Ongeki 加密端点配置；格式为十六进制盐:迭代次数，多个配置以逗号分隔"},
		{Key: "ongeki_game_data_dir", Value: "", Desc: "Ongeki 静态数据目录；兼容 AquaDX data/game/ongeki 下的 JSON 文件，也可使用 ONGEKI_GAME_DATA_DIR"},
